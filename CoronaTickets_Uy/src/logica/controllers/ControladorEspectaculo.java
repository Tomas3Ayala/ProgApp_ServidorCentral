...
Connection conn = ConexionDB.getInstance().getConnection();
    ...
    public void cargar_datos_de_prueba() {
        try {
            ...
            String pass = "123";
            // Espectadores
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("eleven11", "Eleven", "Ten", "eleven11@gmail.com", new Date(1971 - 1900, 12, 31), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\eleven.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("costas", "Gerardo", "Costas", "gcostas@gmail.com", new Date(1983 - 1900, 11, 15), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\gerardo.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("waston", "Emma", "Watson", "e.watson@gmail.com", new Date(1990 - 1900, 4, 15), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\emma.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("house", "Gregory", "House", "greghouse@gmail.com", new Date(1959 - 1900, 5, 15), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\drhouse.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("sergiop", "Sergio", "Puglia", "puglia@alpanpan.com.uy", new Date(1950 - 1900, 1, 28), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\sergio.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("chino", "Alvaro", "Recoba", "chino@trico.org.uy", new Date(1976 - 1900, 3, 17), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\RECOBA ALVARO.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("tonyp", "Antonio", "Pacheco", "eltony@manya.org.uy", new Date(1955 - 1900, 2, 14), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\pacheco.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("lachiqui", "Mirtha", "Legrand", "lachiqui@hotmail.com.ar", new Date(1927 - 1900, 2, 23), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\mirtha.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_espectador(new Espectador("cbochinche", "Cacho", "Bochinche", "cbochinche@vera.com.uy", new Date(1937 - 1900, 5, 8), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\cacho.jpg")));
            
            // Artistas
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("Village People es una innovadora formación musical de estilo disco de finales de los años 70. Fue famosa tanto por sus peculiares disfraces, como por sus canciones pegadizas, con letras sugerentes y llenas de dobles sentidos.","Grupo americano del disco creado por Jacques Morali y Henry Belolo en 1977. Según Marjorie Burgess, todo comenzó cuando Morali fue a un bar gay de Nueva York una noche y notó al bailarín Felipe Rose vestido como un nativo americano.","www.officialvillagepeople.com","vpeople", "Village", "People", "vpeople@tuta.io", new Date(1977 - 1900, 1, 1), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\vpeople.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("Depeche Mode es un grupo inglés de música electrónica formado en Basildon, Essex, en 1980 por Vicent Clarke y Andrew John Fletcher, a los que se unieron Martin Lee Gore y poco después David Gahan. Actualmente se le considera como grupo de música alternativa.","","www.depechemode.com","dmode", "Depeche", "Mode", "dmode@tuta.io", new Date(1980 - 1900, 6, 14), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\depeche.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("Cynthia Ann Stephanie Lauper, conocida simplemente como Cyndi Lauper, es una cantautora, actriz y empresaria estadounidense. Después de participar en el grupo musical, Blue Angel, en 1983 firmó con Portrait Records (filial de Epic Records) y lanzó su exitoso álbum debut She's So Unusual a finales de ese mismo año. Siguió lanzando una serie de álbumes en los que encontró una inmensa popularidad, superando los límites de contenido de las letras de sus canciones.","Cynthia Ann Stephanie Lauper, (Brooklyn, Nueva York; 22 de junio de 1953). ","cyndilauper.com","clauper", "Cyndi", "Lauper", "clauper@hotmail.com", new Date(1953, 6, 22), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\cindy.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("Bruce Frederick Joseph Springsteen (Long Branch, Nueva Jersey, 23 de septiembre de 1949),​ más conocido como Bruce Springsteen, es un cantante, músico y compositor estadounidense. ","","brucespringsteen.net","bruceTheBoss", "Bruce", "Springsteen", "bruceTheBoss@gmail.com", new Date(1949, 9, 23), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\bruce.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("La Triple Nelson es un grupo de rock uruguayo formado en enero de 1998 e integrado inicialmente por Christian Cary (guitarra y voz), Fernando \"Paco\" Pintos (bajo y coros) y Rubén Otonello (actualmente su nuevo baterista es Rafael Ugo).","","www.latriplenelson.uy","tripleNelson", "La Triple", "Nelson", "tripleNelson@tuta.io", new Date(1998 - 1900, 1, 1), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\triple.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("La Ley fue una banda chilena de rock formada en 1987 por iniciativa del tecladista y guitarrista. En un principio, La Ley tenía la aspiración de ser un grupo de música tecno. Este disco resulta ser un éxito de ventas y reciben una invitación al Festival Internacional de Viña del Mar de febrero de 1994.","","www.lasleyesdenewton.com","la_ley", "La", "Ley", "la_ley@tuta.io", new Date(1987 - 1900, 2, 14), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\newton_joven.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("Pimpinela es un dúo musical argentino compuesto por los hermanos Lucía Galán y Joaquín Galán. Pimpinela ha editado veinticuatro discos","","www.pimpinela.net","lospimpi", "Pimpinela", "Pimpinela", "lospimpi@gmail.com", new Date(1981 - 1900, 8, 13), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\newton_joven.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("José Gómez Romero, conocido artísticamente como Dyango es un cantante español de música romántica.","","","dyangounchained", "Dyango", "Ango", "dyangounchained@gmail.com", new Date(1940, 3, 5), -1, pass), Files.readAllBytes(Paths.get("imagenes para lab 3\\pimpi.jpg")));
            Fabrica.getInstance().getInstanceControllerUsuario().registrar_artista(new Artista("Su carrera comienza en 1976 cuando forma la banda Los Playeros junto a su hermano Víctor. Al poco tiempo se mudan a San Luis donde comienzan a hacerse conocidos en la escena musical. Su éxito a nivel nacional llega a comienzos de los años 1990 cuando desembarca en Buenos Aires y graba el éxito \"Violeta\", originalmente compuesta e interpretada en 1985 por el músico brasileño Luiz Caldas bajo el título «Fricote».","","","alcides", "Alcides", "Violeta", "alcides@tuta.io", new Date(1952 - 1900, 7, 17), -1, pass),Files.readAllBytes(Paths.get("imagenes para lab 3\\alcides.jpg")));
            ...
            // Espectaculos
            Fabrica.getInstance().getInstanceControladorPlataforma().crear_Espectaculo(new Espectaculo("Instagram Live", "Los Village Volvieron", "Espectáculo de retorno de los Village People.", 90, 10 ,  800, "https://www.instagram.com/realvillagepeople/", 550, new Date(2020 - 1900, 3, 31), 10, EstadoEspectaculo.ACEPTADO), Files.readAllBytes(Paths.get("imagenes para lab 3\\Los Village.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().crear_Espectaculo(new Espectaculo("Facebook Watch", "Global Spirit", "Espectáculo donde se presenta el álbum Spirit.", 120, 30 ,  1300, "https://es-la.facebook.com/depechemode/", 750, new Date(2020 - 1900, 4, 20), 11, EstadoEspectaculo.ACEPTADO), Files.readAllBytes(Paths.get("imagenes para lab 3\\global spirit.png")));
            Fabrica.getInstance().getInstanceControladorPlataforma().crear_Espectaculo(new Espectaculo("Twitter Live", "Memphis Blues World", "Espectáculo promoviendo álbum Memphis Blues.", 110, 5 ,  1000, "https://twitter.com/cyndilauper", 800, new Date(2020 - 1900, 5, 30), 12, EstadoEspectaculo.ACEPTADO),Files.readAllBytes(Paths.get("imagenes para lab 3\\memphis.png")));
            Fabrica.getInstance().getInstanceControladorPlataforma().crear_Espectaculo(new Espectaculo("Youtube", "Springsteen on Broadway", "Springsteen tocando guitarra o piano y relatando anécdotas recogidas en su autobiografía de 2016, Born to Run. ", 100, 100 ,  1500, "https://www.youtube.com/BruceSpringsteen", 980, new Date(2020 - 1900, 6, 7), 13, EstadoEspectaculo.ACEPTADO), Files.readAllBytes(Paths.get("imagenes para lab 3\\spring.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().crear_Espectaculo(new Espectaculo("Twitter Live", "Bien de Familia", "El dúo estará presentando sus más sonados éxitos y también nuevas canciones . ", 150, 10,  500, "https://twitter.com/PimpinelaNet", 500, new Date(2020 - 1900, 7, 8), 16, EstadoEspectaculo.ACEPTADO), Files.readAllBytes(Paths.get("imagenes para lab 3\\pimpinela.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().crear_Espectaculo(new Espectaculo("Twitter Live", "30 años", "Espectáculo conmemorando los 30 años de Violeta.", 80, 30 ,  150, "https://twitter.com/alcides_shows", 450, new Date(2020 - 1900, 7, 31), 18, EstadoEspectaculo.ACEPTADO),Files.readAllBytes(Paths.get("imagenes para lab 3\\violeta.jpg")));
            
            // Funciones
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Los Village Volvieron - 1", new Date(2020 - 1900, 4, 15), 15, new Date(2020 - 1900, 3, 31), -1, 1), Files.readAllBytes(Paths.get("imagenes para lab 3\\Los Village.jpg")));
            ...
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Los Village Volvieron - 2", new Date(2020 - 1900, 5, 1), 17, new Date(2020 - 1900, 3, 31), -1, 1), Files.readAllBytes(Paths.get("imagenes para lab 3\\Los Village.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(13, 2);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Los Village Volvieron - 3", new Date(2020 - 1900, 6, 1), 18, new Date(2020 - 1900, 3, 31), -1, 1), Files.readAllBytes(Paths.get("imagenes para lab 3\\Los Village.jpg")));
            ...
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Global Spirit (I)", new Date(2020 - 1900, 6, 10), 19, new Date(2020 - 1900, 4, 20), -1, 2), Files.readAllBytes(Paths.get("imagenes para lab 3\\global spirit.png")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(10, 4);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Global Spirit (II)", new Date(2020 - 1900, 7, 10), 20, new Date(2020 - 1900, 4, 20), -1, 2), Files.readAllBytes(Paths.get("imagenes para lab 3\\global spirit.png")));
            ...
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Global Spirit (III)", new Date(2020 - 1900, 8, 10), 17, new Date(2020 - 1900, 4, 20), -1, 2), Files.readAllBytes(Paths.get("imagenes para lab 3\\global spirit.png")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(16, 6);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Memphis Blues World - A", new Date(2020 - 1900, 8, 15), 16, new Date(2020 - 1900, 5, 30), -1, 3), Files.readAllBytes(Paths.get("imagenes para lab 3\\memphis.png")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(13, 7);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Memphis Blues World - B", new Date(2020 - 1900, 8, 31), 19, new Date(2020 - 1900, 5, 30), -1, 3),Files.readAllBytes(Paths.get("imagenes para lab 3\\memphis.png")));
            ...
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Memphis Blues World - C", new Date(2020 - 1900, 9, 30), 20, new Date(2020 - 1900, 5, 30), -1, 3),Files.readAllBytes(Paths.get("imagenes para lab 3\\memphis.png")));
            ...
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Springsteen on Broadway - i", new Date(2020 - 1900, 9, 1), 19, new Date(2020 - 1900, 6, 7), -1, 4),Files.readAllBytes(Paths.get("imagenes para lab 3\\spring.jpg")));
            ...
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Springsteen on Broadway - ii", new Date(2020 - 1900, 9, 30), 17, new Date(2020 - 1900, 6, 7), -1, 4),Files.readAllBytes(Paths.get("imagenes para lab 3\\spring.jpg")));
            ...
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Springsteen on Broadway - iii", new Date(2020 - 1900, 10, 15), 20, new Date(2020 - 1900, 6, 7), -1, 4), Files.readAllBytes(Paths.get("imagenes para lab 3\\spring.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(15, 12);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Bien de Familia - A", new Date(2020 - 1900, 9, 25), 19, new Date(2020 - 1900, 7, 8), -1, 5),Files.readAllBytes(Paths.get("imagenes para lab 3\\pimpinela.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(18, 13);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Bien de Familia - B", new Date(2020 - 1900, 10, 25), 18, new Date(2020 - 1900, 7, 8), -1, 5),Files.readAllBytes(Paths.get("imagenes para lab 3\\pimpinela.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(14, 14);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("Bien de Familia - C", new Date(2020 - 1900, 11, 25), 17, new Date(2020 - 1900, 7, 8), -1, 5),Files.readAllBytes(Paths.get("imagenes para lab 3\\pimpinela.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("30 años - 1", new Date(2020 - 1900, 9, 1), 21, new Date(2020 - 1900, 7, 31), -1, 6),Files.readAllBytes(Paths.get("imagenes para lab 3\\violeta.jpg")));
            Fabrica.getInstance().getInstanceControladorPlataforma().insertar_Artista_Invitado(17, 16);
            Fabrica.getInstance().getInstanceControladorPlataforma().Alta_de_Funcion(new Funcion("30 años - 2", new Date(2020 - 1900, 10, 1), 21, new Date(2020 - 1900, 7, 31), -1, 6),Files.readAllBytes(Paths.get("imagenes para lab 3\\violeta.jpg")));
            ...
            Fabrica.getInstance().getInstanceControladorEspectaculo().registrar_paquete(new Paquete("Paquete de Bandas", "Paquete de bandas musicales.", new Date(2020 - 1900, 5, 1), new Date(2020 - 1900, 7, 31), 20, -1),Files.readAllBytes(Paths.get("imagenes para lab 3\\bandas.jpg")));
            Fabrica.getInstance().getInstanceControladorEspectaculo().registrar_paquete(new Paquete("Paquete Solistas", "Paquete de solistas.", new Date(2020 - 1900, 8, 1), new Date(2020 - 1900, 9, 30), 30, -1),Files.readAllBytes(Paths.get("imagenes para lab 3\\solistas.jpg")));
            Fabrica.getInstance().getInstanceControladorEspectaculo().registrar_paquete(new Paquete("Paquete Latino", "Paquete de espectáculos latinos.", new Date(2020 - 1900, 8, 15), new Date(2020 - 1900, 11, 15), 15, -1),Files.readAllBytes(Paths.get("imagenes para lab 3\\latinos.jpg")));
